...
vim.keymap.set("n", "<leader>r&", function() harpoon:list():removeAt(1) end)
vim.keymap.set("n", "<leader>ré", function() harpoon:list():removeAt(2) end)
vim.keymap.set("n", "<leader>r\"", function() harpoon:list():removeAt(3) end)
vim.keymap.set("n", "<leader>r'", function() harpoon:list():removeAt(4) end)
