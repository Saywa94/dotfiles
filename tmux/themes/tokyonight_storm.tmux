...
set -g status-left "#[fg=#24283b,bg=#f7e79a,bold] #S #[fg=#7aa2f7,bg=#24283b,nobold,nounderscore,noitalics]"
set -g status-right "#[fg=#24283b,bg=#24283b,nobold,nounderscore,noitalics] #[fg=#7aa2f7,bg=#24283b] #{prefix_highlight} #[fg=#3b4261,bg=#24283b,nobold,nounderscore,noitalics] #[fg=#7aa2f7,bg=#3b4261] %d-%m-%Y  #[fg=#24283b,bg=#7aa2f7,bold] %H:%M "
