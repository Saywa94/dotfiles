...
set -g status-right "#[fg=#363537,bg=#363537,nobold,nounderscore,noitalics] #[fg=#fcfcfa,bg=#363537] #{prefix_highlight} #[fg=#363537,bg=#363537,nobold,nounderscore,noitalics] #[fg=#363537,bg=#ffd866] %d-%m-%Y #[fg=#363537,bg=#363537] #[fg=#363537,bg=#fc9867] %H:%M #[fg=#363537,bg=#363537]"
